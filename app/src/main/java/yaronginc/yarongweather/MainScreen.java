...
public class MainScreen extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clothing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainScreen.this,MainScreen3.class);
                startActivity(i);
            }
        });
    ...
    private class GetWeather extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            Picasso.with(MainScreen.this).load(Common.getImage(openWeatherMap.getWeather().get(0).getIcon())).into(imageView);
